...
if __name__ == "__main__":
    ...
    try_errors += kodik.main_test(TOKEN=KODIK_TOKEN, GLOBAL_USE_LXML=GLOBAL_USE_LXML, GLOBAL_TOKEN_VALIDATION=GLOBAL_TOKEN_VALIDATION, proxy=proxy)
    print('\n=== KODIK === ASYNC TEST ===')
    try_errors += asyncio.run(kodik.async_test(TOKEN=KODIK_TOKEN, GLOBAL_USE_LXML=GLOBAL_USE_LXML, GLOBAL_TOKEN_VALIDATION=GLOBAL_TOKEN_VALIDATION, proxy=proxy))
    print('\n=== KODIK === API TEST ===')
    try_errors += kodik.api_test(TOKEN=KODIK_TOKEN, proxy=proxy)
