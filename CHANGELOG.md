...
- Добавлена функция получения информации об аниме и эпизодах
- Добавлены параметры mirror и proxy для animego
- Добавлены в парсер animego функции получения расписания выхода на текущую неделю, список аниме текущего сезона, список обновлений аниме
- Добавлены функции получения расписания выхода аниме для парсера кодика (для синхронной версии может использоваться как staticmethod)
- Переработана система тестирования
- Добавлен синхронный вариант парсера анимего
- Добавлена документация для парсера animego и функции расписания выхода аниме для парсера кодика
