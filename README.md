...
4. Получить список аниме с шикимори по фильтрам
    ```python
    parser.get_anime_list('статус аниме', 'тип аниме', 'начальная страница', 'количество страниц для парсинга', 'принцип сортировки')
    ```
    Доступные фильтры:
    - status - текущий статус выхода (по умолчанию all)
        - all - любой
        - ongoing - онгоинг
        - anons - анонс
        - released - вышло
        - latest - вышло недавно
    - anime_type - тип аниме (по умолчанию all)
        - all - любой
        - tv - TV Сериал
        - movie - Фильм
        - ova - OVA
